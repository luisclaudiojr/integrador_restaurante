	...
	<body style="background: black;">
		<div id='menu' class="fe_menu_index">
			<ul>
				...
				<li><a class="desabilitar_link" data-titulo="pendencias"href="/consulta/pedidos_pendentes.php"><i class="pendencias"></i>pendências</a></li><!-- PENDENCIAS - MOSTRA PEDIDO - QTD E MESA - POR ORDEM DE DATA -->
			<ul>
		</div>
	</body>
</html>